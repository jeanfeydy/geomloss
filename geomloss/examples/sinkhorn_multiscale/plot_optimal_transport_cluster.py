...
X_i = X_i + .05 * torch.randn(N, 4).type(dtype)  # + some noise
...
Loss =  SamplesLoss("sinkhorn", p=2, blur=.05, scaling=.8) 
...
print("Wasserstein distance: {:.3f}, computed in {:.3f}s.".format(
...
print("Our clusters have standard deviations of {:.3f} and {:.3f}.".format(std_i, std_j))
